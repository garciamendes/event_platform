...
// Local
import { IGetLessonBySlug, IVideoProps } from './type'
...
export function Video({ lessonSlug }: IVideoProps) {
  const { data } = useQuery<IGetLessonBySlug>(GET_LESSON_BY_SLUG_QUERY, {
          ...
          <div className='flex-1'>
            ...
            <div className='flex items-center gap-4 mt-6'>
              ...
              <div className='leading-relaxed'>
                ...
                <p className='text-gray-200 text-sm block'>{data.lesson.teacher.bio}</p>
              </div>
            </div>
          </div>
